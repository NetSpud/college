...
function SearchBox() {
  return <input aria-label="Search box" type="text" placeholder="Search..." className="lg:mt-0 mt-3 h-min ml-auto lg:w-auto lg:mx-0 mx-auto w-2/3 placeholder:text-white text-white bg-ekc-b4 pl-3 py-3 rounded-md focus:outline-none" />;
}
